                            ...
                            <li className='bg-slate-100 border border-slate-200 shadow-md mt-1 rounded-lg relative px-10'>
                                ...
                                <div className='flex  py-3 px-5'>
                                    ...
                                    <div className='ml-20'>
                                        ...
                                        <div className='mt-8'>
                                            <button className='py-2 px-2 rounded-full ring-1 ring-red-500 hover:bg-red-500 hover: drop-shadow-lg active:bg-red-600'><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-red-500 hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
