                    ...
                    <form>
                        <div className='form-control mt-5 mx-12'>
                            <label className='block'>
                                ...
                                <input type="text" className='form-input placehold px-4 py-3 w-72 rounded-full shaddow-sm border border-slate-200 invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500 ' placeholder='Your name...' autoComplete='off' onChange={(e) => { setName(e.target.value) }} value={name} />
                            </label>
                        </div>
                        <div className='form-control mt-5 mx-12'>
                            <label className='block'>
                                <span className='block text-md font-medium text-slate-700'>Email</span>
                                <input type="email" className='form-input placehold px-4 py-3 w-72 rounded-full shaddow-sm border border-slate-200 invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500 ' placeholder='example@mail.com' autoComplete='off' onChange={(e) => { setEmail(e.target.value) }} value={email} />
                            </label>
                        </div>
                        <div className='form-control mt-3 mx-12'>
                            <label className='block'>
                                <span className='block text-md font-medium text-slate-700'>Password</span>
                                <input type="password" className='form-input placehold px-4 py-3 w-72 rounded-full shaddow-sm border border-slate-200' placeholder='Password' onChange={(e) => { setPassword(e.target.value) }} value={password} />
                            </label>
                        </div>
                        <div className='mt-3'>
                            ...
                            <div className='pb-1'>
                                <button className='text-center px-7 py-2 rounded-xl my-6 block mx-auto text-white text-lg bg-primary hover:bg-white hover:text-[#FA1D58] hover:drop-shadow-md focus:ring-1 focus:ring-pink-500' onClick={handleSubmit}> Sign Up </button>
                            </div>
                        </div>
                    </form>
                </div>
